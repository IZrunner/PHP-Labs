...
<header>
	...
	<section> 
		<a href="forms/create-student.php">Додати студента</a>
		...
		<tbody>
			<?php foreach ($data['students'] as $key => $student): ?>
				<?php if(!$_POST['stud_name_filter'] || stristr($student['name'], $_POST['
					stud_name_filter'])): ?> 
				<?php 
					$row_class ='row';
			...
			<tr class="<?php echo $row_class; ?>"> 
			 	...
			 	<td>
			 		...
			 		<td>
			 			<a href='forms/edit-student.php?file=<?php  
			 			echo $student['file']; 
			 			?>'>Редагувати</a>

			 			<a href='forms/delete-student.php?file=<?php
			 				echo $student['file'];	
			 			?>'>Видалити</a>
			 		</td>
			 </tr>
